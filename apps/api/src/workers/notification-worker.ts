 ...
 */
async function sendMobilePush(userNotificationId: string, user: { id: string; devicePushToken?: string | null }, notification: { title: string; body: string; data?: any }): Promise<void> {
 ...
 */
async function sendWebPush(userNotificationId: string, user: { id: string; webPushSubscriptions: Array<any> }, notification: { title: string; body: string; data?: any }): Promise<void> {
