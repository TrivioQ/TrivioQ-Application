...
export default async function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white selection:bg-brand-500 selection:text-white pb-20">
      {/* ── Hero Section ── */}
      <div className="relative overflow-hidden pt-20 pb-16 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4">
          <h1 className="text-5xl md:text-6xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-brand-200 to-white">{t('title')}</h1>
