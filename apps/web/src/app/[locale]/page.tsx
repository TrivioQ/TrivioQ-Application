...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen text-gray-900 dark:text-white selection:bg-brand-500 selection:text-white">
      {/* ── Hero Section ── */}
      <section className="relative pt-16 pb-20 px-6 lg:px-8 overflow-hidden flex-grow flex items-center">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-brand-100 via-slate-50 to-white dark:from-brand-900/50 dark:via-gray-950 dark:to-black" />
      ...
      {/* ── Social Proof Strip ── */}
      <section className="py-10 px-6 border-y border-gray-100 dark:border-white/5 bg-white/20 dark:bg-white/2">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl className="grid max-w-xl grid-cols-1 gap-x-12 gap-y-16 lg:max-w-none lg:grid-cols-3">
              {/* Feature 1 */}
              <div className="flex flex-col bg-brand-50/60 dark:bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl border border-brand-100 dark:border-white/5 hover:border-brand-300 dark:hover:border-brand-500/30 transition-colors shadow-sm dark:shadow-none">
                <dt className="flex items-center gap-x-4 text-xl font-semibold leading-7 text-gray-900 dark:text-white">
                  <div className="h-12 w-12 rounded-xl bg-brand-500/10 dark:bg-brand-500/20 flex items-center justify-center border border-brand-500/20 dark:border-brand-500/30 text-2xl">⚡</div>
