    ...
    <div className="flex flex-col min-h-screen text-gray-900 dark:text-white selection:bg-blue-500 selection:text-white">
      ...
      <section className="relative pt-16 pb-20 px-6 lg:px-8 overflow-hidden flex-grow flex items-center">
        ...
        <div className="mx-auto max-w-5xl text-center">
          <div className="inline-flex items-center rounded-full px-3 py-1 text-sm font-semibold text-blue-600 dark:text-indigo-300 ring-1 ring-inset ring-blue-500/30 dark:ring-indigo-500/30 mb-8 bg-blue-50 dark:bg-indigo-500/10">{t('badge')}</div>
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-tight text-gray-900 dark:text-white">
            {t('titlePrefix')} <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-orange-400 to-blue-600 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400">{t('titleHighlight')}</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link href="#" className="rounded-full bg-blue-500 dark:bg-indigo-500 px-8 py-4 text-lg font-semibold text-white shadow-[0_0_20px_rgba(59,130,246,0.4)] dark:shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:bg-blue-400 dark:hover:bg-indigo-400 hover:shadow-[0_0_30px_rgba(59,130,246,0.6)] transition-all duration-300 transform hover:-translate-y-1 w-full sm:w-auto">
              {t('downloadButton')}
            </Link>
            <Link href="/leaderboard" className="group text-lg font-semibold leading-6 text-gray-700 dark:text-white hover:text-blue-600 dark:hover:text-indigo-300 transition-colors flex items-center gap-2">
              {t('leaderboardLink')}
      ...
      <section className="py-24 px-6 sm:px-8 relative border-t border-gray-100/50 dark:border-white/5">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-blue-600 dark:text-indigo-400 uppercase tracking-widest">{t('features.tagline')}</h2>
