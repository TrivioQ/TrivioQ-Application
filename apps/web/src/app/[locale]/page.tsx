          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl className="grid max-w-xl grid-cols-1 gap-x-12 gap-y-16 lg:max-w-none lg:grid-cols-3">
              {[
                ...
                <div key={title} className="flex flex-col bg-brand-50/60 dark:bg-overlay/50 backdrop-blur-sm p-8 rounded-2xl border border-brand-100 dark:border-white/5 hover:border-brand-300 dark:hover:border-brand-500/30 transition-colors shadow-sm dark:shadow-none">
