...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen text-gray-900 dark:text-white selection:bg-teal-500 selection:text-white">
      {/* ── Hero Section ── */}
      <section className="relative pt-16 pb-20 px-6 lg:px-8 overflow-hidden flex-grow flex items-center">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-100 via-slate-50 to-white dark:from-teal-900/50 dark:via-gray-950 dark:to-black" />
        <div className="mx-auto max-w-5xl text-center">
          <div className="inline-flex items-center rounded-full px-3 py-1 text-sm font-semibold text-teal-600 dark:text-teal-300 ring-1 ring-inset ring-teal-500/30 dark:ring-teal-500/30 mb-8 bg-teal-50 dark:bg-teal-500/10">{t('badge')}</div>
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-tight text-gray-900 dark:text-white">
            {t('titlePrefix')} <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-purple-500 to-pink-500 dark:from-teal-400 dark:via-purple-400 dark:to-pink-400">{t('titleHighlight')}</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/leaderboard" className="group text-base font-semibold leading-6 text-gray-700 dark:text-white hover:text-teal-600 dark:hover:text-teal-300 transition-colors flex items-center gap-2">
              {t('leaderboardLink')}
      ...
      <section className="py-20 px-6 sm:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-14">
            <h2 className="text-base font-semibold leading-7 text-teal-600 dark:text-teal-400 uppercase tracking-widest">How it works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={step} className="relative flex flex-col items-start p-8 bg-white/60 dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-white/10 backdrop-blur-sm">
                <div className="text-xs font-bold tracking-widest text-teal-500 dark:text-teal-400 mb-4 uppercase">{step}</div>
      ...
      <section className="py-24 px-6 sm:px-8 relative border-t border-gray-100/50 dark:border-white/5">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-teal-600 dark:text-teal-400 uppercase tracking-widest">{t('features.tagline')}</h2>
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl className="grid max-w-xl grid-cols-1 gap-x-12 gap-y-16 lg:max-w-none lg:grid-cols-3">
              {/* Feature 1 */}
              <div className="flex flex-col bg-teal-50/60 dark:bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl border border-teal-100 dark:border-white/5 hover:border-teal-300 dark:hover:border-teal-500/30 transition-colors shadow-sm dark:shadow-none">
                <dt className="flex items-center gap-x-4 text-xl font-semibold leading-7 text-gray-900 dark:text-white">
                  <div className="h-12 w-12 rounded-xl bg-teal-500/10 dark:bg-teal-500/20 flex items-center justify-center border border-teal-500/20 dark:border-teal-500/30 text-2xl">⚡</div>
              ...
              {/* Feature 2 */}
              <div className="flex flex-col bg-orange-50/60 dark:bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl border border-orange-100 dark:border-white/5 hover:border-orange-300 dark:hover:border-teal-500/30 transition-colors shadow-sm dark:shadow-none">
                <dt className="flex items-center gap-x-4 text-xl font-semibold leading-7 text-gray-900 dark:text-white">
