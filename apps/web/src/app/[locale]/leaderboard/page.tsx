...
export default async function LeaderboardPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen py-20 px-6 sm:px-8 text-gray-900 dark:text-white selection:bg-teal-500">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 flex flex-col md:flex-row justify-between items-end gap-6">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-teal-600 to-purple-600 dark:from-blue-400 dark:via-teal-400 dark:to-purple-400">{t('title')}</h1>
