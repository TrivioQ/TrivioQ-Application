...
export function Navbar() {
  ...
  return (
    <>
      {/* ── Bar ── */}
      <header className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? 'bg-bg-secondary/75 backdrop-blur-2xl border-b border-brand-100 dark:border-white/10 shadow-lg shadow-brand-500/15 dark:shadow-black/20' : 'bg-bg-secondary/50 dark:bg-transparent backdrop-blur-md border-b border-transparent'}`}>
