          ...
          <>
            ...
            <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-[101] p-4">
              <motion.div initial={{ scale: 0.95, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.95, opacity: 0, y: 20 }} className="w-full max-w-md bg-gray-900 border border-white/10 rounded-3xl p-8 shadow-2xl pointer-events-auto overflow-hidden relative">
                <div className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r ${options.isDestructive ? 'from-red-500 to-orange-500' : 'from-teal-500 to-purple-500'}`} />
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-end">
                  ...
                  <button onClick={() => handleClose(true)} className={`px-8 py-3 rounded-2xl text-sm font-bold text-white shadow-lg transition-all ${options.isDestructive ? 'bg-red-500 hover:bg-red-400 shadow-red-500/20' : 'bg-teal-500 hover:bg-teal-400 shadow-teal-500/20'}`}>
