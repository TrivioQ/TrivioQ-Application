  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, #e0e7ff 0%, #f0f9ff 30%, #fdf2f8 60%, #fff7ed 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, #0f0c29 0%, #030524 40%, #0a0a2e 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at center, rgba(251,146,60,0.25) 0%, transparent 65%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at center, rgba(168,85,247,0.22) 0%, transparent 65%)',
        }}
      />
    </>
  );
